...
4. **Put phone-specific CSS in `mobileChatShell.css`.** This file is the single source of truth for all phone-layout CSS. Do not scatter phone styles into feature-specific CSS files.
