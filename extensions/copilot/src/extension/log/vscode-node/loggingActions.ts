...
`);
			...
			const secondaryUrls: {
				...
				connect: (fetcher: IFetcher, url: string) => Promise<Response>;
			}[] = [
				microsoftIsOneDS
					? {
						...
						connect: (fetcher, url) => sendRawTelemetry(fetcher, this.envService, url, this._context, 'GitHub.copilot-chat/diagnosticsTelemetryProbe', {}),
					}
					: {
