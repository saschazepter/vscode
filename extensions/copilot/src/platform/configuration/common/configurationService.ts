	...
	export namespace Advanced {
		...
		*/
		...
		export const InlineEditsXtabProviderModelConfiguration = (() => {
			...
			migrateSetting(newKey, oldKey);
			return defineSetting<xtabPromptOptions.ModelConfiguration | undefined>(newKey, ConfigType.Simple, undefined, xtabPromptOptions.MODEL_CONFIGURATION_VALIDATOR, { oldKey });
		})();
	}
