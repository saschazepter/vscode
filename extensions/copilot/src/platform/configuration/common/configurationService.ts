...
export namespace ConfigKey {
	...
	*/
	export namespace TeamInternal {
		...
		export const InlineEditsRejectShownGhostText = defineTeamInternalSetting<boolean>('chat.advanced.inlineEdits.rejectShownGhostText', ConfigType.ExperimentBased, false);
