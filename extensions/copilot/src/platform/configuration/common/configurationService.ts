...
export namespace ConfigKey {
	...
	*/
	export namespace TeamInternal {
		...
		export const GhostTextUseCompletionsFetchService = defineTeamInternalSetting<boolean>('chat.advanced.ghostText.useCompletionsFetchService', ConfigType.ExperimentBased, true);
