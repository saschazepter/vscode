...
async function main() {
	...
	// TODO: just for debugging, remove. Write build timestamp file.
	const buildTs = new Date().toISOString();
	fs.writeFileSync(path.join(REPO_ROOT, 'src', 'platform', 'inlineEdits', 'node', 'nesBuildTimestamp.ts'),
		`// Auto-generated by .esbuild.ts — DO NOT EDIT\nexport const NES_BUILD_TIMESTAMP = ${JSON.stringify(buildTs)};\n`);
