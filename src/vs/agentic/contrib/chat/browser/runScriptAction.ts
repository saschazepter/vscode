...
import { IQuickPickItem, IQuickInputService, IQuickPickSeparator } from '../../../../platform/quickinput/common/quickInput.js';
...
import { ILaunch, IDebugService } from '../../../../workbench/contrib/debug/common/debug.js';
