...
import './media/titleBarWidget.css';
 ...
 */
export class TitleBarWidget extends BaseActionViewItem {
 ...
 */
export class TitleBarContribution extends Disposable implements IWorkbenchContribution {
	...
	constructor(
		...
		this._register(actionViewItemService.register(Menus.CommandCenter, Menus.TitleBarControlMenu, (action, options) => {
			...
			return instantiationService.createInstance(TitleBarWidget, action, options);
		}, undefined));
	}
}
