...
export class CommandCenterControl {
	...
	constructor(
		...
		const titleToolbar = instantiationService.createInstance(MenuWorkbenchToolBar, this.element, Menus.CommandCenter, {
			...
			actionViewItemProvider: (action, options) => {
				if (action instanceof SubmenuItemAction && action.item.submenu === Menus.CommandCenterCenter) {
