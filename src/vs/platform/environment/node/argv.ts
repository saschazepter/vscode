...
export const OPTIONS: OptionDescriptions<Required<NativeParsedArgs>> = {
	...
	'sessions-utility-process': { type: 'boolean', cat: 'o', description: localize('sessionsUtilityProcess', "Opens the sessions window with the Copilot utility process backend.") },
