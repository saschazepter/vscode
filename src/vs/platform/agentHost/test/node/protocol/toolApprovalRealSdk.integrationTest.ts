...
import { isSubagentSession, ToolResultContentType, type ISessionState, type ITerminalState, type IToolResultContent, type IToolResultSubagentContent } from '../../../common/state/sessionState.js';
import {
	getActionEnvelope,
