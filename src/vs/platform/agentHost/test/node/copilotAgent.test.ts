...
import type { CopilotClient, CopilotClientOptions, CopilotSession, ModelInfo, PermissionAllowAllMode, SessionEvent, SessionEventHandler, SessionEventPayload, SessionEventType, TypedSessionEventHandler } from '@github/copilot-sdk';
