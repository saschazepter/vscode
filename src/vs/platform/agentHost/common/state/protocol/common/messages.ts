...
import type { AgentGlobalConfigurationState, CancelAgentAccountLoginParams, ListSessionsParams, ListSessionsResult, LogoutAgentAccountParams, ReadAgentAccountParams, ReadAgentGlobalConfigurationParams, ResolveSessionConfigParams, ResolveSessionConfigResult, SessionConfigCompletionsParams, SessionConfigCompletionsResult, StartAgentAccountLoginParams, StartAgentAccountLoginResult, WriteAgentGlobalConfigurationParams } from '../channels-root/commands.js';
import type { AgentAccountState } from '../channels-root/state.js';
...
export interface CommandMap {
	...
	'readAgentAccount': { params: ReadAgentAccountParams; result: AgentAccountState };
	'startAgentAccountLogin': { params: StartAgentAccountLoginParams; result: StartAgentAccountLoginResult };
	'cancelAgentAccountLogin': { params: CancelAgentAccountLoginParams; result: null };
	'logoutAgentAccount': { params: LogoutAgentAccountParams; result: null };
	'readAgentGlobalConfiguration': { params: ReadAgentGlobalConfigurationParams; result: AgentGlobalConfigurationState };
	'writeAgentGlobalConfiguration': { params: WriteAgentGlobalConfigurationParams; result: AgentGlobalConfigurationState };
