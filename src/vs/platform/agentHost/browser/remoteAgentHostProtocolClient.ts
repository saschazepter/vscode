...
import type { ActionEnvelope, ClientAction, INotification } from '../common/state/sessionActions.js';
...
export class RemoteAgentHostProtocolClient extends Disposable implements IAgentConnection {
	 ...
	 */
	dispatchAction(action: ClientAction, _clientId: string, clientSeq: number): void {
