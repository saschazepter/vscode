...
export class MenuId {
	...
	static readonly AgentSessionsWelcomeFilterSubMenu = new MenuId('AgentSessionsWelcomeFilterSubMenu');
	static readonly AgentSessionsQuickPickFilterSubMenu = new MenuId('AgentSessionsQuickPickFilterSubMenu');
