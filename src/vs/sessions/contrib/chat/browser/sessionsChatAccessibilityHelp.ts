...
export class SessionsChatAccessibilityHelp implements IAccessibleViewImplementation {
	...
	getProvider(accessor: ServicesAccessor) {
		...
		content.push(localize('sessionsChat.vscodePet', "Type /vscode-pet to show or hide the VS Code pet above the input. When it is visible, use Tab to focus it and press Enter or Space to show it some love."));
