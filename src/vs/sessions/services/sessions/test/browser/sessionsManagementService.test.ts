...
class TestSessionsProvider extends mock<ISessionsProvider>() {
	...
	override getModelsSnapshot(): { models: readonly ILanguageModelChatMetadataAndIdentifier[]; desiredModelResolution: { kind: 'notRequested' } } { return { models: [], desiredModelResolution: { kind: 'notRequested' } }; }
