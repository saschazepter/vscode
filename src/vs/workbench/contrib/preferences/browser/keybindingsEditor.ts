...
export class KeybindingsEditor extends EditorPane<IKeybindingsEditorMemento> implements IKeybindingsEditorPane {
	...
	private createHeader(parent: HTMLElement): void {
		...
		const headerControlsContainer = DOM.append(this.headerContainer, $('.keybindings-header-controls'));
		const openKeybindingsJsonButton = this._register(new Button(headerControlsContainer, { secondary: true, title: true, ...defaultButtonStyles }));
		openKeybindingsJsonButton.label = localize('openKeybindingsJson', "Open Keyboard Shortcuts (JSON)");
