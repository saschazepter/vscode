...
import { AgentSessionsViewContainerId } from '../agentSessions/agentSessions.js';
...
export class ChatTeardownContribution extends Disposable implements IWorkbenchContribution {
	...
	private maybeHideAuxiliaryBar(): void {
		...
		const hasAgentSessionsView = activeContainers.some(container => container.id === AgentSessionsViewContainerId);
		if (
