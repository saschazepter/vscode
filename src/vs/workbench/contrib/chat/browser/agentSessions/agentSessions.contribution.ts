...
import { AgentSessionsViewerService, IAgentSessionsViewerService } from './agentSessionsViewerService.js';
...
registerSingleton(IAgentSessionsViewerService, AgentSessionsViewerService, InstantiationType.Delayed);
