...
configurationRegistry.registerConfiguration({
	...
	properties: {
		...
		[AgentHostCopilotSdkLogLevelSettingId]: {
			...
			enumDescriptions: [
				nls.localize('chat.agentHost.copilotSdk.logLevel.default', "Follow the agent host's log level. Running VS Code with trace logging enables all Copilot SDK runtime logs."),
				nls.localize('chat.agentHost.copilotSdk.logLevel.none', "Disable Copilot SDK runtime logging."),
				nls.localize('chat.agentHost.copilotSdk.logLevel.error', "Log errors only."),
				nls.localize('chat.agentHost.copilotSdk.logLevel.warning', "Log warnings and errors."),
				nls.localize('chat.agentHost.copilotSdk.logLevel.info', "Log informational messages, warnings, and errors."),
				nls.localize('chat.agentHost.copilotSdk.logLevel.debug', "Log debug information and all less verbose messages."),
				nls.localize('chat.agentHost.copilotSdk.logLevel.all', "Log all Copilot SDK runtime diagnostics."),
			],
