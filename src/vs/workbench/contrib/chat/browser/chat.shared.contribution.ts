...
import { AgentHostAhpJsonlLoggingSettingId, AgentHostSdkSandboxEnabledSettingId, ClaudePreferAgentHostAgentsSettingId, ClaudePreferAgentHostEditorSettingId, CodexPreferAgentHostAgentsSettingId, CodexPreferAgentHostEditorSettingId } from '../../../../platform/agentHost/common/agentService.js';
...
configurationRegistry.registerConfiguration({
	...
	properties: {
		...
		[CodexPreferAgentHostAgentsSettingId]: {
			type: 'boolean',
			markdownDescription: nls.localize('chat.agents.codex.preferAgentHost', "When enabled, Codex sessions opened from the Agents Window run inside the agent host process using the Codex App Server instead of the OpenAI extension. Only one Codex implementation surfaces per window. Requires `#chat.agentHost.enabled#` and `#chat.agentHost.codexAgent.enabled#`."),
			default: false,
			tags: ['experimental'],
			experiment: { mode: 'startup' },
		},
