...
export class ChatInputPart extends Disposable implements IHistoryNavigationWidget {
	...
	private gettingStartedTipContainer!: HTMLElement;
	...
	get gettingStartedTipContainerElement(): HTMLElement | undefined {
		return this.gettingStartedTipContainer;
	}
	...
	render(container: HTMLElement, initialValue: string, widget: IChatWidget) {
		...
		if (this.options.renderStyle === 'compact') {
			elements = dom.h('.interactive-input-part', [
				dom.h('.interactive-input-and-edit-session', [
					...
					dom.h('.chat-getting-started-tip-container@gettingStartedTipContainer', { style: { display: 'none' } }),
		...
		this.gettingStartedTipContainer = elements.gettingStartedTipContainer;
