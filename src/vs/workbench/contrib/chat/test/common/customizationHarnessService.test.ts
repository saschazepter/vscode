...
suite('CustomizationHarnessService', () => {
	...
	suite('registerExternalHarness', () => {
		...
		test('external harness item provider returns items', async () => {
			...
			store.add(emitter);
			const testItems = [
				{ uri: URI.parse('file:///workspace/.claude/SKILL.md'), type: 'skill', name: 'Test Skill', description: 'A test skill', extensionId: undefined },
			];
		...
		test('uses the active harness provider for prompt and skill items', async () => {
			...
			const service = createService({
				...
				itemProvider: {
					onDidChange: emitter.event,
					provideChatSessionCustomizations: async () => [
						{ uri: URI.parse('file:///workspace/.test/prompts/fix.prompt.md'), type: PromptsType.prompt, name: 'fix', description: 'Fix something', extensionId: undefined },
						{ uri: URI.parse('file:///workspace/.test/skills/lint/SKILL.md'), type: PromptsType.skill, name: 'lint', description: 'Lint skill', extensionId: undefined },
						{ uri: URI.parse('file:///workspace/.test/instructions/rule.instructions.md'), type: PromptsType.instructions, name: 'rule', description: 'Ignore me', extensionId: undefined },
						{ uri: URI.parse('file:///workspace/.test/skills/disabled/SKILL.md'), type: PromptsType.skill, name: 'disabled', enabled: false, extensionId: undefined },
					],
				},
			});
		...
		test('uses provider item URIs to scope resolved custom agents', async () => {
			...
			const service = new CustomizationHarnessServiceBase([{
				...
				itemProvider: {
					onDidChange: emitter.event,
					provideChatSessionCustomizations: async () => [
						{ uri: URI.parse('file:///workspace/.test/agents/selected.agent.md'), type: PromptsType.agent, name: 'selected', extensionId: undefined },
						{ uri: URI.parse('file:///workspace/.test/agents/disabled.agent.md'), type: PromptsType.agent, name: 'disabled', enabled: false, extensionId: undefined },
					],
				},
