...
import { isSessionAction, type ActionEnvelope, type ClientAction, type INotification } from '../../../../../../platform/agentHost/common/state/sessionActions.js';
...
suite('AgentHostClientTools', () => {
	...
	suite('client tools registration', () => {
		...
		class MockAgentHostConnection extends mock<IAgentHostService>() {
			...
			public dispatchedActions: ClientAction[] = [];
