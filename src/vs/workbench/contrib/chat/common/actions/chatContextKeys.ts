...
export namespace ChatContextKeys {
	...
	export const requestNeedsInput = new RawContextKey<boolean>('chatSessionRequestNeedsInput', false, { type: 'boolean', description: localize('interactiveSessionRequestNeedsInput', "True when the current request needs input from the user.") });
