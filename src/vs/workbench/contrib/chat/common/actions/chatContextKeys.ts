...
export namespace ChatContextKeys {
	...
	export const hasPendingQuestionCarousel = new RawContextKey<boolean>('chatHasPendingQuestionCarousel', false, { type: 'boolean', description: localize('chatHasPendingQuestionCarousel', "True when the active response has pending question carousel answers.") });
