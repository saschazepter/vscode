...
class AddElementToChatAction extends Action2 {
	...
	constructor() {
		...
		super({
			...
			f1: false,
			precondition: ContextKeyExpr.and(enabled, CONTEXT_BROWSER_HAS_ACTIVE_PAGE, CONTEXT_BROWSER_HAS_ERROR.negate()),
...
class OpenInExternalBrowserAction extends Action2 {
	...
	constructor() {
		super({
			...
			precondition: CONTEXT_BROWSER_URL,
			menu: {
				id: MenuId.BrowserActionsToolbar,
				group: ActionGroupPage,
				order: 10
...
class ShowBrowserFindAction extends Action2 {
	...
	constructor() {
		super({
			...
			category: BrowserCategory,
			f1: false,
			precondition: ContextKeyExpr.and(CONTEXT_BROWSER_HAS_ACTIVE_PAGE, CONTEXT_BROWSER_HAS_ERROR.negate()),
			menu: {
				id: MenuId.BrowserActionsToolbar,
				group: ActionGroupPage,
				order: 1,
