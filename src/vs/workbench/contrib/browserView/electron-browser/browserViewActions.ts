...
class AddElementToChatAction extends Action2 {
	...
	constructor() {
		...
		super({
			...
			f1: true,
			precondition: ContextKeyExpr.and(BROWSER_EDITOR_ACTIVE, CONTEXT_BROWSER_HAS_ACTIVE_PAGE, CONTEXT_BROWSER_HAS_ERROR.negate(), enabled),
...
class ShowBrowserFindAction extends Action2 {
	...
	constructor() {
		super({
			...
			category: BrowserCategory,
			f1: true,
			precondition: ContextKeyExpr.and(BROWSER_EDITOR_ACTIVE, CONTEXT_BROWSER_HAS_ACTIVE_PAGE, CONTEXT_BROWSER_HAS_ERROR.negate()),
			menu: {
				id: MenuId.BrowserActionsToolbar,
				group: ActionGroupPage,
				order: 1,
