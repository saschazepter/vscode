...
import { IMcpHostDelegate, IMcpMessageTransport } from './mcpRegistry.js';
import { McpServerRequestHandler } from './mcpServerRequestHandler.js';
import { IMcpCollectionDefinition, IMcpServerConnection, IMcpServerDefinition, McpConnectionState, McpServerLaunch } from './mcpTypes.js';
...
export class McpServerConnection extends Disposable implements IMcpServerConnection {
	...
	public readonly connection: IObservable<McpServerRequestHandler | undefined> = this._requestHandler;

	private readonly _loggerId: string;
	private readonly _logger: ILogger;

	constructor(
		private readonly _collection: IMcpCollectionDefinition,
