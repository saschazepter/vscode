...
class DefaultAccountProvider extends Disposable implements IDefaultAccountProvider {
	...
	private async getMcpRegistryProvider(sessions: AuthenticationSession[], accountPolicyData: IAccountPolicyData | undefined): Promise<{ data: (IMcpRegistryProvider & { allRegistries?: ReadonlyArray<IMcpRegistryProvider> }) | null; fetchedAt: number } | undefined> {
