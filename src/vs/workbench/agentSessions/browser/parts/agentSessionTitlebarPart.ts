...
import { MultiWindowParts, Part } from '../../../browser/part.js';
...
import { AgentSessionsCommandCenterControl } from './agentSessionsCommandCenterControl.js';
import { WorkbenchToolBar } from '../../../../platform/actions/browser/toolbar.js';
import { ACCOUNTS_ACTIVITY_ID, GLOBAL_ACTIVITY_ID } from '../../../common/activity.js';
import { AccountsActivityActionViewItem, isAccountsActionVisible, SimpleAccountActivityActionViewItem, SimpleGlobalActivityActionViewItem } from '../../../browser/parts/globalCompositeBar.js';
...
import { ACCOUNTS_ACTIVITY_TILE_ACTION, GLOBAL_ACTIVITY_TITLE_ACTION } from '../../../browser/parts/titlebar/titlebarActions.js';
import { createInstantHoverDelegate } from '../../../../base/browser/ui/hover/hoverDelegateFactory.js';
import { IBaseActionViewItemOptions } from '../../../../base/browser/ui/actionbar/actionViewItems.js';
import { IHoverDelegate } from '../../../../base/browser/ui/hover/hoverDelegate.js';
import { safeIntl } from '../../../../base/common/date.js';
import { ITitlebarPart, ITitleProperties, ITitleVariable, IAuxiliaryTitlebarPart } from '../../../browser/parts/titlebar/titlebarPart.js';
 ...
 */
export class AgentSessionsTitlebarPart extends Part implements ITitlebarPart {
	...
	protected override createContentArea(parent: HTMLElement): HTMLElement {
		...
		// Context menu
		{
			this._register(addDisposableListener(this.rootContainer, EventType.CONTEXT_MENU, e => {
				EventHelper.stop(e);
				this.onContextMenu(e, AgentSessionsWorkbenchMenus.TitleBarContext);
			}));
		}
	...
	private createTitle(): void {
		...
		const commandCenter = this.instantiationService.createInstance(
			AgentSessionsCommandCenterControl,
			this.windowTitle,
			this.hoverDelegate
		);
	...
	private createActionToolBarMenus(update: true | { layoutActions?: boolean; globalActions?: boolean; activityActions?: boolean } = true): void {
		...
		if (update.globalActions) {
			...
			this.globalToolbarMenu = this.menuService.createMenu(AgentSessionsWorkbenchMenus.TitleBarRight, this.contextKeyService);
 ...
 */
export class MainAgentSessionsTitlebarPart extends AgentSessionsTitlebarPart {
 ...
 */
export class AuxiliaryAgentSessionsTitlebarPart extends AgentSessionsTitlebarPart implements IAuxiliaryTitlebarPart {
	...
	constructor(
		...
		editorGroupsContainer: IEditorGroupsContainer,
		private readonly mainTitlebar: AgentSessionsTitlebarPart,
		@IContextMenuService contextMenuService: IContextMenuService,
		@IConfigurationService configurationService: IConfigurationService,
		@IBrowserWorkbenchEnvironmentService environmentService: IBrowserWorkbenchEnvironmentService,
		@IInstantiationService instantiationService: IInstantiationService,
		...
		const id = AuxiliaryAgentSessionsTitlebarPart.COUNTER++;
 ...
 */
export class AgentSessionsTitleService extends MultiWindowParts<AgentSessionsTitlebarPart> implements ITitleService {

	declare _serviceBrand: undefined;

	readonly mainPart: AgentSessionsTitlebarPart;
	...
	constructor(
		...
		this.mainPart = this._register(this.instantiationService.createInstance(MainAgentSessionsTitlebarPart));
	...
	createAuxiliaryTitlebarPart(container: HTMLElement, editorGroupsContainer: IEditorGroupsContainer, instantiationService: IInstantiationService): IAuxiliaryTitlebarPart {
		...
		const titlebarPart = instantiationService.createInstance(AuxiliaryAgentSessionsTitlebarPart, titlebarPartContainer, editorGroupsContainer, this.mainPart);
