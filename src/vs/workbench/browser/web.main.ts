...
export class BrowserMain extends Disposable {
	...
	/**
	 * Creates the workspace context, configuration, and storage services.
	 * Override this to provide different workspace/configuration implementations
	 * (e.g., sessions in-memory workspace).
	 */
