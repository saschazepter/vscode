...
export interface MainThreadChatAgentsShape2 extends IChatAgentProgressShape, IDisposable {
	...
	$registerChatSessionCustomizationProvider(handle: number, chatSessionType: string, metadata: IChatSessionCustomizationProviderMetadataDto, extension: ExtensionIdentifier, hasSetEnabled: boolean): void;
...
export interface ExtHostChatAgentsShape2 {
	...
	$setCustomizationEnabled(handle: number, uri: UriComponents, type: string, enabled: boolean, scope: 'global' | 'workspace'): Promise<void>;
